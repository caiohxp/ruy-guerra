...
<section class="conteudo">
	...
	<img class="ruy" src="images/ruy_guerra.png" alt="Ruy Guerra" title="Ruy Guerra" /><img class="tituloCategoria" src="images/prefaciosv.jpg" alt="prefácios" title="prefácios" />
	<br />
...
if ($idioma == 3) {
	...
	<p>
	<a href=\"prefacios.php?idioma=3\">VOLTAR</a> | 
	<a href=\"#topo\">TOPO</a> | 
	...
	echo "<footer id=\"rodape\">
	<p>
	<a href=\"prefacios.php?idioma=2\">VOLTAR</a> | 
	<a href=\"#topo\">TOPO</a> | 
