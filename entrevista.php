...
<section class="conteudo">
	...
	<img class="ruy" src="images/ruy_guerra.png" alt="Ruy Guerra" title="Ruy Guerra" /><img class="tituloCategoria" src="images/entrevistasv.jpg" alt="entrevistas" title="entrevistas" />
	<br />
...
if ($idioma == 3) {
	...
	<p>
	<a href=\"entrevistas.php?idioma=3\">VOLTAR</a> | 
	<a href=\"#topo\">TOPO</a> | 
	...
	echo "<footer id=\"rodape\">
	<p>
	<a href=\"entrevistas.php?idioma=2\">VOLTAR</a> | 
	<a href=\"#topo\">TOPO</a> | 
	...
	echo "<footer id=\"rodape\">
	<p>
	<a href=\"entrevistas.php\">VOLTAR</a> | 
	<a href=\"#topo\">TOPO</a> | 
