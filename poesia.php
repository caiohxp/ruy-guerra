...
<section class="conteudo">
	...
	<img class="ruy" src="images/ruy_guerra.png" alt="Ruy Guerra" title="Ruy Guerra" /><img class="tituloCategoria" src="images/poesiasv.jpg" alt="poesias" title="poesias" />
	<br />
...
if ($idioma == 3) {
	...
	<p>
	<a href=\"poesias.php?idioma=3\">VOLTAR</a> | 
	<a href=\"#topo\">TOPO</a> | 
	...
	echo "<footer id=\"rodape\">
	<p>
	<a href=\"poesias.php?idioma=2\">VOLTAR</a> | 
	<a href=\"#topo\">TOPO</a> | 
